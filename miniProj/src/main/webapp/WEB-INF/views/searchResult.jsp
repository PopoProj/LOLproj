...
<body>
	...
	double topPick = (double) (searched.getLaneMap().get("TOP").get("win") + searched.getLaneMap().get("TOP").get("defeat"))
			/ 10;
	double jgPick = (double) (searched.getLaneMap().get("JUNGLE").get("win")
			+ searched.getLaneMap().get("JUNGLE").get("defeat")) / 10;
	double midPick = (double) (searched.getLaneMap().get("MIDDLE").get("win")
			+ searched.getLaneMap().get("MIDDLE").get("defeat")) / 10;
	double botPick = (double) (searched.getLaneMap().get("BOTTOM").get("win")
			+ searched.getLaneMap().get("BOTTOM").get("defeat")) / 10;
	double supPick = (double) (searched.getLaneMap().get("UTILITY").get("win")
			+ searched.getLaneMap().get("UTILITY").get("defeat")) / 10;
	%>


	<header>
		<div class="homeBtn">
			<a href="/"> <img class="popoHome" src="../../images/popo.png"
				width="256px" height="144px" />
			</a>
		</div>

		<div class="topnav">
			<a class="active" href="toMyPage"> 마이페이지</a> <a class="active"
				href="toBoard"> 게시판 </a>
			<%
	...
	<main>
		<div class="left" style="float: left;">
			...
			<div class="leftTop">
				<div class="infoLeft" style="height: 300px">
					<img
						src="../../images/profileicon/<%=searched.getProfileIconId()%>.png"
						alt="profileIcon" width='150' height='150' />
					<div>
		...
		%>
			<div
				OnClick="location.href ='/matchDetails?matchId=<%=temp.getMatchId()%>'"
				style="cursor: pointer;">
				<div class='matchLeft' style='background-color: <%=colour%>'>
					<img src="../../images/champion/<%=temp.getChampionName()%>.png"
						alt="champImg" width='80' height='80' /> Lv.
					<%=temp.getChampLevel()%>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<%=temp.getKills()%>
					/
